        ...
        {state.step === "power-source" && (
          <motion.div key="power-source" {...stepTransition}>
            <StepPowerSource
              ...
              byokKeyValidationStatus={state.byokKeyValidationStatus}
              byokKeyValidationErrors={state.byokKeyValidationErrors}
              onValidateByokKeyAsync={actions.validateByokKeyAsync}
              mode={state.mode}
              stepNumber={currentMeta.number}
              stepCode={currentMeta.code}
            />
